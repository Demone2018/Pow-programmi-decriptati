' ===========================================
' POW Program Sequencer v5 - Modulo VBA
' ===========================================
' Genera un UNICO programma MDB combinando
' le funzioni dei programmi 30, 31, 32, 33
' nella sequenza desiderata
' ===========================================
' v5: Copia sia Soudure che Script_Prog
'     Campo corretto: sp_NumLig per Script_Prog
'     so_CodProg e sp_CodProg sincronizzati
'     Rinumerazione linee su entrambe tabelle
' ===========================================
